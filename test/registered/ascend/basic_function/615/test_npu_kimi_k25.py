...
# from sglang.test.ascend.test_ascend_utils import KIMI_K2_5_W4A8_MODEL_PATH
# Runs on both H200 and B200 via nightly-8-gpu-common suite
register_cuda_ci(est_time=3600, suite="nightly-8-gpu-common", nightly=True)

# KIMI_K2_5_W4A8_MODEL_PATH = "moonshotai/Kimi-K2.5"
KIMI_K2_5_W4A8_MODEL_PATH = "/home/weights/Kimi-K2.5-w4a8"
