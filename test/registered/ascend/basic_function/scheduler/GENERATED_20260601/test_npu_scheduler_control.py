...
class TestNPUAbort(CustomTestCase):
    """Test abort functionality on NPU.

    [Test Category] Scheduler
    [Test Target] Request abort, memory leak prevention
    """
...
class TestNPUAbortWithApiKey(CustomTestCase):
    """Test abort with API key on NPU.

    [Test Category] Scheduler
    [Test Target] Request abort with API key authentication
    """
...
class TestNPUAbortAllWithRetraction(CustomTestCase):
    """Test abort all with retraction on NPU.

    [Test Category] Scheduler
    [Test Target] Abort all requests with retraction, waiting queue handling
    """
