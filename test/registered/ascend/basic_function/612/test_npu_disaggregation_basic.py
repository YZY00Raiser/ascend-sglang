...
class TestNPUDisaggregationAccuracy(
    ...
    def test_logprob(self):
        """Verify input and output token logprobs are returned correctly."""
    ...
    def test_chat_completion_top_logprobs(self):
        """Verify OpenAI chat completion API with top logprobs."""
    ...
    def test_first_token_finish(self):
        """Verify finish behavior when the first generated token is EOS or stop."""
        client = openai.Client(api_key="empty", base_url=f"{self.lb_url}/v1")
