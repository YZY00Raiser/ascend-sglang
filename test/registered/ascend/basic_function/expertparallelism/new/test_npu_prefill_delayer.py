...
class TestPrefillDelayerNegotiate(unittest.TestCase):
    """Test prefill delayer negotiate logic on NPU.

    [Test Category] Scheduler Unit Test
    [Test Target] PrefillDelayer negotiation logic
    """
...
class TestPrefillDelayerThroughputOnlineServing(CustomTestCase):
    """Test prefill delayer throughput in online serving mode on NPU.

    [Test Category] Scheduler Performance Test
    [Test Target] Prefill Delayer throughput optimization
    """
...
class TestPrefillDelayerThroughputOfflineGen(CustomTestCase):
    """Test prefill delayer throughput in offline generation mode on NPU.
...
class TestPrefillDelayerTokenUsageLowWatermark(CustomTestCase):
    """Test prefill delayer token usage low watermark on NPU.

    [Test Category] Scheduler Feature Test
    [Test Target] Token usage watermark mechanism
    """
