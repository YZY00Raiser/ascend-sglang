...
_NEGOTIATE_TEST_CASES = [
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[True, True, True, True, True, True, True, True],
                token_usage=[0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
            )
        ],
        expected_allow=True,
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[True, False, True, False, True, False, True, False],
                token_usage=[0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
            ),
            NegotiateCall(
                prefillable=[True, True, True, True, True, True, True, True],
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[False, False, False, False, False, False, False, False],
                token_usage=[0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
            )
        ],
        expected_allow=True,
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[True, False, True, False, True, False, True, False],
                token_usage=[0.5, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
            )
        ],
        expected_allow=True,
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[False, False, True, False, True, False, True, False],
                token_usage=[0.5, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
            )
        ],
        expected_allow=False,
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                prefillable=[True, True, True, True, True, True, True, True],
                token_usage=[0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9],
                running_batch=[100, 100, 100, 100, 100, 100, 100, 100],
                max_prefill_bs=[80, 80, 80, 80, 80, 80, 80, 80],
                waiting_queue_len=[10, 10, 10, 10, 10, 10, 10, 10],
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                ...
                running_batch=[100, 100, 100, 100, 100, 100, 100, 100],
                max_prefill_bs=[80, 80, 80, 80, 80, 80, 80, 80],
                waiting_queue_len=[64, 64, 64, 64, 64, 64, 64, 64],
                max_running_requests=1024,
            )
        ],
        expected_allow=True,
    ...
    NegotiateTestCase(
        ...
        calls=[
            NegotiateCall(
                ...
                running_batch=[100, 100, 100, 100, 100, 100, 100, 100],
                max_prefill_bs=[80, 80, 80, 80, 80, 80, 80, 80],
                waiting_queue_len=[1, 1, 1, 1, 1, 1, 1, 1],
                max_running_requests=1024,
            )
        ],
        expected_allow=True,
...
class TestNPUPrefillDelayerThroughputOfflineGen(CustomTestCase):
...
class TestNPUPrefillDelayerTokenUsageLowWatermark(CustomTestCase):
...
class TestNPUPrefillDelayerAccuracy(CustomTestCase):
